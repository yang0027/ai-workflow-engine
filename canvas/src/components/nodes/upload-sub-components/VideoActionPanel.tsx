  ...
  return (
    <div
      ...
      style={{
        ...
        borderRadius: '12px',
        padding: '5px 6px', // 更加小巧的外框 padding
        display: 'flex',
        ...
        >
          ...
          {activeVideoPanel === 'hd' && (
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
              ...
              <button
                onClick={() => handleVideoFixAction('4K 画质超分')}
                style={{
          ...
          {activeVideoPanel === 'cut' && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '4px', width: '100%', textAlign: 'left' }}>
              ...
              <div style={{ display: 'flex', gap: '4px', alignItems: 'center' }}>
                ...
                <button
                  onClick={() => handleVideoFixAction('段落切片裁剪')}
                  style={{
                    background: 'rgba(168, 85, 247, 0.25)',
                    border: '1px solid rgba(168, 85, 247, 0.4)',
                    borderRadius: '5px',
          ...
          {activeVideoPanel === 'audio-split' && (
            <div style={{ display: 'flex', gap: '4px', width: '100%' }}>
              {[
                ...
                <button
                  key={btn.m}
                  onClick={() => handleAudioSplit(btn.m)}
                  style={{
                    flex: 1,
          ...
          {activeVideoPanel === 'video-fix' && (
            <div style={{ display: 'flex', gap: '4px', width: '100%' }}>
              {[
                ...
                <button
                  key={btn.m}
                  onClick={() => handleVideoFixAction(btn.m)}
                  style={{
                    flex: 1,
                    background: 'rgba(255, 255, 255, 0.03)',
                    border: '1px solid rgba(255, 255, 255, 0.08)',
            ...
            <button
              ...
              onClick={() => {
                if (tool.directAction) {
                  ...
                  setActiveVideoPanel(active ? null : tool.id);
                }
              }}
              style={{
                padding: isIcon ? '4px 5px' : '4px 4px',
                borderRadius: '5px',
