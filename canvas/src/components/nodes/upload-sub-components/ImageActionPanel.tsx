...
export const ImageActionPanel: React.FC<ImageActionPanelProps> = ({
  ...
  return (
    <div
      ...
      style={{
        position: 'absolute',
        bottom: '190px', // 悬浮在节点上方，且二级菜单往上生长
        left: '50%',
        ...
        borderRadius: '12px',
        padding: '5px 6px', // 紧密外框 padding
        display: 'flex',
        flexDirection: 'column',
        gap: '5px',
        zIndex: 1000,
        animation: 'slideUpSub 0.25s cubic-bezier(0.16, 1, 0.3, 1)',
      }}
    >
      <style>{`
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px' }}>
                <div
                  style={{
                    ...
                    boxShadow: '0 0 10px rgba(168, 85, 247, 0.3), inset 0 0 6px rgba(255,255,255,0.2)',
              ...
              <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '6px' }}>
                ...
                <input
                  ...
                  style={{ width: '100%', accentColor: '#a855f7', height: '3px', background: 'rgba(255,255,255,0.1)', borderRadius: '1.5px' }}
                />
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px' }}>
                <div
                  style={{
                    ...
                    boxShadow: `0 0 12px ${lightColor}44, inset 0 0 6px rgba(255,255,255,0.15)`,
                  }}
                />
              ...
              <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '4px' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '6px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '2px' }}>
                    ...
                    <input
                      ...
                      style={{ width: '16px', height: '14px', border: 'none', background: 'none', cursor: 'pointer' }}
                    />
                  </div>
                  <div style={{ display: 'flex', gap: '3px' }}>
                    {['#ec4899', '#3b82f6', '#10b981', '#f59e0b', '#ffffff'].map((c) => (
                      <div
                        ...
                        style={{ width: '10px', height: '10px', borderRadius: '50%', background: c, border: lightColor === c ? '1px solid #fff' : 'none', cursor: 'pointer' }}
                      />
                    ))}
                  </div>
                </div>
                ...
                <input
                  ...
                  style={{ width: '100%', accentColor: '#a855f7', height: '2.5px', background: 'rgba(255,255,255,0.1)' }}
                />
                  ...
                  {lightPresets.map((p) => (
                    <button
                      ...
                      style={{
                        ...
                        border: '1px solid ' + (selectedLightPreset === p ? 'rgba(168, 85, 247, 0.4)' : 'rgba(255, 255, 255, 0.05)'),
                        color: '#fff',
                        fontSize: '8px',
                        cursor: 'pointer',
                      }}
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '3px' }}>
                    {cameraPans.map((c) => (
                      <button
                        ...
                        style={{ padding: '3px 4px', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)', borderRadius: '4px', color: 'rgba(255,255,255,0.8)', fontSize: '8.5px', textAlign: 'left', cursor: 'pointer' }}
                      >
                        {c}
                      </button>
                    ))}
              ...
              <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
                ...
                >
                  <div
                    style={{
                      position: 'absolute',
                      width: cropRatio === '1:1' ? '30px' : cropRatio === '4:3' ? '40px' : cropRatio === '16:9' ? '56px' : cropRatio === '9:16' ? '20px' : '48px',
                      height: cropRatio === '1:1' ? '30px' : cropRatio === '4:3' ? '30px' : cropRatio === '16:9' ? '32px' : cropRatio === '9:16' ? '36px' : '24px',
                ...
                <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '4px' }}>
                  ...
                  <input
                    ...
                    style={{ width: '100%', accentColor: '#a855f7', height: '2.5px' }}
                  />
                </div>
              </div>
